...
import AgentOurs from "./AgentOurs";
        ...
        <div className="hero mt-10">
          <div className="hero-content flex-col lg:flex-row gap-12">
            <motion.img
              ...
              className="w-full lg:max-w-lg rounded-xl"
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 20 }}
            >
              <h3 className="text-center lg:text-start text-2xl mb-4 font-bold text-[#1AA3D0]">
                Why Choose Us
              </h3>
              <h1 id="title" className="text-4xl font-bold text-start text-gray-700">
              ...
              <div className="text-start">
                <Link to="/">
                  <button className="btn btn-primary mr-4 rounded-full bg-[#1AA3D0] ">Go Home</button>
                </Link>
                <Link to="/contact">
                  <button className="btn btn-primary mr-4 rounded-full bg-[#1AA3D0] ">
                    Contact us
                  </button>
                </Link>
              </div>
