      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="grid mt-10 grid-cols-1 gap-8 lg:grid-cols-4 md:grid-cols-2">
          <div className="text-center md:border-r border-b md:border-b-0 border-green-400">
            <h6 className="text-4xl  font-bold lg:text-7xl  xl:text-6xl">
          ...
          <div className="text-center  border-b md:border-b-0 border-green-400">
            <h6 className="text-4xl font-bold lg:text-5xl xl:text-6xl">
              <CountUp start={0} end={57} duration={10} delay={2}></CountUp>
            </h6>
            <p className="text-sm  font-bold tracking-widest text-[#00A99D] uppercase lg:text-base">
              Top rated teacher
            </p>
            <p className="m-3 text-start ">
