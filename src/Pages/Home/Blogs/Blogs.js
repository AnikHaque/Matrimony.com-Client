...
const Blogs = () => {
    ...
    return (
        <div className='py-9'>
            <p className="bg-gradient-to-r text-transparent bg-clip-text from-green-400 via-green-500 to-green-600 font-semibold pb-2 text-center" >Our Recent Blogs</p>
            <h1 className='text-3xl mb-3 px-3  md:text-4xl font-semibold text-black text-center'>Check Out Our Recent Blogs<br /> From Here Now</h1>
